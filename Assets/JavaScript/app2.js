...
function songlistgetter2(songlist) {
    ...
    $.ajax({
        ...
        var tvShow = result.parse.links[Math.floor((Math.random() * 80) + 1)]["*"];

        var queryURL = "https://itunes.apple.com/search?term=" + tvShow + "&limit=1";
        $.ajax({
            url: queryURL,
            dataType: "jsonp",
            success: function (response) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $("#buylink2").attr({ href: " https://geo.itunes.apple.com/us/album/id" + response.results[0].collectionId + "?i=" + response.results[0].trackId + "&at=1000lR4Q" })
                        $("#amazonlink2").attr({ href: "https://www.amazon.com/gp/search?ie=UTF8&tag=locationsong1-20&linkCode=ur2&linkId=a2760e14a2d286d92bc32fdeae1f4b8d&camp=1789&creative=9325&index=digital-music&keywords=" + response.results[0].artistName + " " + response.results[0].trackName })
                        ...
                        $('#title2').html(selectedTrackname);
                        $('#artist2').html(selectedArtist);
                        $('#wiki2').html(selectedTrackId);
                        $("#linkhere2").html(image);
                        ...
                        $.ajax({
                            ...
                            $('#vid2').attr('src', 'https://www.youtube.com/embed/' + videoID);
                        });
...
function artistGetter2() {
    ...
    $.ajax({
        url: "https://cors-anywhere.herokuapp.com/http://en.wikipedia.org/w/api.php?action=query&format=json&list=categorymembers&cmtitle=Category:PBS_original_programming",
...
$("#submit2").on("click", function (event) {
    ...
    database.ref().on("child_added", function (snapshot) {
        ...
        $('#title2').html(tdtitle);
        $('#artist2').html(tdartist);
        $('#wiki2').html(tdtrackid);
...
$("#loveit2").on("click", function (event) {
    event.preventDefault();
